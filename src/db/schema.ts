...
export const decks = sqliteTable(
  "decks",
  {
    ...
    forkOf: integer("fork_of").references((): AnySQLiteColumn => decks.id, {
      onDelete: "set null",
    }),
  ...
  (table) => [
    ...
    index("decks_forkOf_idx").on(table.forkOf),
    index("decks_isPublic_idx").on(table.isPublic),
  ],
);
...
export const studySessions = sqliteTable("study_sessions", {
  ...
  uniqueIndex("sessions_userId_date_unq").on(table.userId, table.date),
]);
