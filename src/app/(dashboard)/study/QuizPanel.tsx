        ...
        <div className="text-center space-y-6 max-w-md w-full">
          ...
          {total === 0 && (
            <div className="space-y-3">
              ...
              <button onClick={onBackToDecks}
                className="px-6 py-3 bg-gradient-to-r from-primary to-secondary text-white rounded-full font-bold shadow-xl shadow-primary/20 hover:opacity-90 transition-all">
                Go to Decks
              </button>
            </div>
          )}
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
            <button onClick={() => { setHistorySaved(false); handleRestart(); }}
              className="px-6 py-3 bg-gradient-to-r from-primary to-secondary text-white rounded-full font-bold shadow-xl shadow-primary/20 hover:opacity-90 transition-all flex items-center justify-center gap-2">
              <span className="material-symbols-outlined text-[20px]">replay</span>
              {total === 0 ? 'Refresh' : 'Try Again'}
            </button>
            {total > 0 && (
              <button onClick={onReviewFlashcards}
