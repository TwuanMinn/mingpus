export function Header() {
  return (
    <header className="flex justify-between items-center w-full px-8 py-4 sticky top-0 z-40 bg-[#fcf8ff]/80 backdrop-blur-xl">
      <div className="md:hidden text-lg font-black text-[#4648d4] font-[family-name:var(--font-jakarta)]">Digital Calligrapher</div>
      ...
      <div className="flex items-center gap-6">
        <div className="relative hidden md:block">
          <input
            className="w-64 pl-4 pr-10 py-2 bg-surface-container-low border-none rounded-full text-sm focus:ring-2 focus:ring-primary/20 transition-all placeholder:text-outline outline-none"
        ...
        <div className="w-8 h-8 rounded-full bg-surface-container-high overflow-hidden border-2 border-primary-fixed">
          <img
            alt="Learner Profile"
