...
export function Sidebar() {
  ...
  return (
    <aside className="flex flex-col fixed left-0 top-0 h-screen p-4 w-64 border-r-0 bg-[#fcf8ff] z-50 hidden md:flex font-[family-name:var(--font-jakarta)] tracking-tight">
      ...
      <div className="mt-auto p-4 bg-surface-container-low rounded-xl">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <p className="text-sm font-bold text-on-surface">Level 4 • HSK 5</p>
